...
class Context_generator:
    ...
    def invoke(self, query):
        ...
        website = 'site:stackoverflow.com'
...
web_quick_search = Tool(
    ...
    Use this tool to find information on an error message, a command or a filter that could not 
    be found in the manuals. Most relevant results will be searched on a technical website and returned.
    ...
    Args:
        query: The search query. For example:
            tshark error 'GET' is too long to be a valid character constant how to fix
    """,
