...
Store the most relevant information as soon as you get them, because the queue has a limited size and older 
...
IMPORTANT: avoid repeating the same query to the we b search tool multiple times, the result won't change.
"""
